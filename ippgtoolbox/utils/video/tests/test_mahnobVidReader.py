...
Project page: tba
-------------------------------------------------------------------------------
Purpose: Purpose: Tests for the MAHNOBVidReader class.
-------------------------------------------------------------------------------
"""
# %%
from ippgtoolbox.utils import MAHNOBVidReader
import matplotlib.pyplot as plt

VIDEO_PATH = '/media/super_fast_storage_2/matthieu_scherpf/2012_01_MAHNOB-HCI/measurements/1/emotion_elicitation/vid'


class TestMAHNOBVidReader:

    def __init__(self):
        self.vid_obj = MAHNOBVidReader(VIDEO_PATH)
...
if __name__ == '__main__':
    ...
    testMAHNOBVidReader = TestMAHNOBVidReader()
    testMAHNOBVidReader.test_readMetaData()
    testMAHNOBVidReader.test_reader_next()
    testMAHNOBVidReader.test_reader_nextAtIndex()
